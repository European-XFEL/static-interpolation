...
\begin{document}
  ...
  \begin{tikzpicture}
    ...
    \fill[xDarkBox] (-1,2) rectangle (3,6);
    \fill[red] (-1,2) rectangle (0,6);
    \fill[red] (-1,5) rectangle (3,6);
    %\fill[xLightBox] (1.5,1.5) rectangle (4.5,4.5);

    \fill[xOrange,draw=black] (1.2,4.2) circle (0.1);
    ...
    \end{scope}
    \draw[step=1cm, gray,dashed] (-1,2) grid (3,6);
    \draw[step=1cm, darkgray] (0,0) grid (6,5);
    \node[fill=white] (label) at (2.5,0.5) {\large Boundary crossing cubic kernel};
